...
parser.add_argument('--rgb-list', default='list/ZC-i3d-test-10crop.list', help='list of rgb features ')
parser.add_argument('--test-rgb-list', default='list/ZC-i3d-test-10crop.list', help='list of test rgb features ')
parser.add_argument('--gt', default='gt_aba2.npy', help='file of ground truth ') ## Changed
...
parser.add_argument('--pretrained', default='ckpt/rtfmfinal.pkl', help='ckpt for pretrained model')
